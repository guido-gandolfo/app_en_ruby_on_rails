...
class VaccinationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vaccination" do
    assert_difference('Vaccination.count') do
      post vaccinations_url, params: { vaccination: { direccion: @vaccination.direccion, zona: @vaccination.zona } }
    end
  ...
  test "should update vaccination" do
    patch vaccination_url(@vaccination), params: { vaccination: { direccion: @vaccination.direccion, zona: @vaccination.zona } }
