...
class VaccinesTest < ApplicationSystemTestCase
  ...
  test "creating a Vaccine" do
    ...
    fill_in "Estado", with: @vaccine.estado
    fill_in "Fecha aplicacion", with: @vaccine.fecha_aplicacion
    fill_in "Nombre vacuna", with: @vaccine.nombre_vacuna
    fill_in "User", with: @vaccine.user_id
